...
from kaspy_tools.utils.addr_libs.bitcash.crypto import ECPrivateKey
from kaspy_tools.utils.addr_libs.bitcash.curve import Point
from kaspy_tools.utils.addr_libs.bitcash.format import (
    bytes_to_wif, public_key_to_address, public_key_to_coords, wif_to_bytes,
    address_to_public_key_hash
)
from kaspy_tools.utils.addr_libs.bitcash.network import NetworkAPI, get_fee, satoshi_to_currency_cached
from kaspy_tools.utils.addr_libs.bitcash.network.meta import Unspent
from kaspy_tools.utils.addr_libs.bitcash.transaction import (
...
class PrivateKey(BaseKey):
    ...
    def get_address(self, prefix):
        ...
        if self._address is None:
            self._address = public_key_to_address(self._public_key, prefix)
