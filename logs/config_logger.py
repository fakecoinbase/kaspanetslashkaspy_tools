...
def make_automation_log_handlers():
    global automation_file_handler
    global automation_stream_handler
    logfile_path = Path(kaspy_tools_constants.LOGS_DIR_PATH) / 'kaspytools.log'
    automation_file_handler = logging.handlers.RotatingFileHandler(logfile_path, mode='a+',  maxBytes=100000000)
